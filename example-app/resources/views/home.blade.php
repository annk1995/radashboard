                            ...
                            <div class="col-md-6 col-lg-4 filtr-item" data-category="2, 4" data-title="" style="opacity: 1; transform: scale(1) translate3d(0px, 0px, 0px); backface-visibility: hidden; perspective: 1000px; transform-style: preserve-3d; position: absolute; width: 380px; transition: all 0.5s ease-out 0ms, width 1ms ease 0s;">
                                ...
                                <div class="card__image card__box-v1">
                                    <div class="card__image-header h-250">
                                        ...
                                        <img src="{{ asset('/').'storage/'.$listing->image }}" alt="" class="img-fluid w100 img-transition">
                                        <div class="info"> for sale</div>
                                    </div>
                                    <div class="card__image-body">
                                        <span class="badge badge-primary text-capitalize mb-2">{{ $listing->type }}</span>
                                        ...
                                        <ul class="list-inline card__content">
                                            <li class="list-inline-item">
                                                ...
                                                <span>
                                                    baths <br>
                                                    <i class="fa fa-bath"></i> {{ $listing->bathroom }}
                                                </span>
                                            </li>
                                            <li class="list-inline-item">
                                                <span>
                                                    beds <br>
                                                    <i class="fa fa-bed"></i> {{ $listing->beds }}
                                                </span>
                                            </li>
                                            <li class="list-inline-item">
                                                <span>
                                                    rooms <br>
                                                    <i class="fa fa-inbox"></i> {{ $listing->rooms }}
                                                </span>
                                            </li>
                                            <li class="list-inline-item">
                                                <span>
                                                    area <br>
                                                    <i class="fa fa-map"></i> {{ $listing->area }} sq ft
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
